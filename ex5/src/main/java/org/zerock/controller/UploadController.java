...
//	@GetMapping("/uploadForm") // 첨부파일 업로
	public void uploadForm() {

//		log.info("upload form");
	}

//	@PostMapping("/uploadFormAction") // 업로드 되는 파일 데이터를 쉽게 처리! 
	public void uploadFormPost(MultipartFile[] uploadFile, Model model) {

		String uploadFolder = "/Users/eunjioh/Desktop/JINNY/CODING/Spring/upload/temp";
...
//			log.info("Upload File Size : " + multipartFile.getSize());
			...
			attachDTO.setFileName(uploadFileName);// 파일 이름 출력해주는 친구!
